...
package.domain = com.github.emanuelet123
...
requirements = python3==3.10.4,kivy==2.2.1,kivymd==1.1.1,sqlite3,kvdroid
...
#presplash.filename = %(source.dir)s/Images/presplash_512x512.png
presplash.filename = Images/presplash_512x512.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/Images/icon_256x256.png
icon.filename = Images/icon_256x256.png
...
# (bool) Indicate if the application should be fullscreen or not (0 or 1)
fullscreen = 0
...
android.presplash_color = #a2c1dd
...
#android.presplash_lottie = lottie_animation.json

# (str) Adaptive icon of the application (used if Android API level is 26+ at runtime)
#icon.adaptive_foreground.filename = %(source.dir)s/Images/icon-adaptative-foreground_500x500.png
icon.adaptive_foreground.filename = Images/icon-adaptative-foreground_500x500.png
#icon.adaptive_background.filename = %(source.dir)s/Images/icon-adaptative-background_108x108.png
icon.adaptive_background.filename = Images/icon-adaptative-background_108x108.png
...
# (int) Target Anroid API, should be as high as possible.
# https://apilevels.com/
#android.api = 31
#android.api = 33
android.api = 26
